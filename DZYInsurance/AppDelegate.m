...
//    YxLoginController *baseTabVC = [[YxLoginController alloc]init];
//    BaseNavigationController *nav = [[BaseNavigationController alloc] initWithRootViewController:baseTabVC];
