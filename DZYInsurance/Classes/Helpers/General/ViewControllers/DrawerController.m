...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.maxY = 0;
    self.offsetLeft = - (SCREEN_WIDTH *0.7);
    self.offsetRight = SCREEN_WIDTH * 0.7;
...
- (CGRect)frameWithOffsetX:(CGFloat)offsetX {
    ...
    rect.origin.y = fabs(rect.origin.x * self.maxY / SCREEN_WIDTH);
    rect.size.height = SCREEN_HEIGHT - 2 * rect.origin.y;
    return rect;
}
